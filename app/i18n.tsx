...
const messages = {
  zh: {
    ...
    'detail.calc.scoreFormula': '综合分 score = {score}',
    ...
    'detail.calc.estimatedScoreExcluded': '估算值仅展示，不参与综合分。',
  ...
  en: {
    ...
    'detail.calc.scoreFormula': 'Composite score = {score}',
    ...
    'detail.calc.estimatedScoreExcluded': 'Estimated values are shown only and excluded from the composite score.',
