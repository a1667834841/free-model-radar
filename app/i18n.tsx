...
const messages = {
  zh: {
    ...
    'eval.formula.hint': '综合分 = 加权 RRF（Σ 权重 ÷ (60 + 名次)）归一化为 0–100；吞吐权重 2×，>300 t/s 降为 0.5×',
  ...
  en: {
    ...
    'eval.formula.hint': 'Score = weighted RRF (Σ weight ÷ (60 + rank)), normalized to 0–100; throughput weight 2×, reduced to 0.5× above 300 t/s',
